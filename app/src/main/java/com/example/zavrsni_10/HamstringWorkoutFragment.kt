...
class HamstringWorkoutFragment : Fragment() {

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        val v = inflater.inflate(R.layout.fragment_hamstring_workout, container, false)
        ...
        val tv_deadlift_link = v.findViewById<TextView>(R.id.tv_exercise1_link)
        val tv_rdl_link = v.findViewById<TextView>(R.id.tv_exercise2_link)
        val tv_gm_link = v.findViewById<TextView>(R.id.tv_exercise3_link)
        val tv_hipthrust_link = v.findViewById<TextView>(R.id.tv_exercise4_link)

        tv_deadlift_link.setOnClickListener(){
            val i = Intent(Intent.ACTION_VIEW, Uri.parse("https://www.youtube.com/watch?v=r4MzxtBKyNE"))
            startActivity(i)
        }
        tv_rdl_link.setOnClickListener(){
            val i = Intent(Intent.ACTION_VIEW, Uri.parse("https://www.youtube.com/watch?v=2SHsk9AzdjA"))
            startActivity(i)
        }
        tv_gm_link.setOnClickListener(){
            val i = Intent(Intent.ACTION_VIEW, Uri.parse("https://www.youtube.com/watch?v=vKPGe8zb2S4"))
            startActivity(i)
        }
        tv_hipthrust_link.setOnClickListener(){
            val i = Intent(Intent.ACTION_VIEW, Uri.parse("https://www.youtube.com/watch?v=OUgsJ8-Vi0E"))
            startActivity(i)
        }
