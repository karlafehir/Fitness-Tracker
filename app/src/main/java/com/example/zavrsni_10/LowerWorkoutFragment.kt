...
class LowerWorkoutFragment : Fragment() {

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ):View? {
        val v = inflater.inflate(R.layout.fragment_lower_workout, container, false)
        ...
        val tv_rdl_link = v.findViewById<TextView>(R.id.tv_exercise5_link)
        val tv_hipthust_link = v.findViewById<TextView>(R.id.tv_exercise6_link)
        ...
        tv_hipthust_link.setOnClickListener(){
